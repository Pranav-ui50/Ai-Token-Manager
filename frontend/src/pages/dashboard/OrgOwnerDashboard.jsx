    ...
    try {
      ...
      if (analyticsResponse.status === 'fulfilled') {
        ...
        setStats(prev => ({
          ...
          features: summary.features?.total || summary.featureCount || 0,
          monthlySpend: extractNumber(summary.monthlySpend || summary.totalCost) || 0,
          tokenUsage: summary.usage?.totalTokens || summary.tokenUsage || 0
        }));
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl font-bold text-gray-900 truncate">{stats.members}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl font-bold text-gray-900 truncate">{stats.projects}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl font-bold text-gray-900 truncate">{stats.features}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-base sm:text-lg font-bold text-gray-900 truncate">{formatCurrency(stats.monthlySpend)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl font-bold text-gray-900 truncate">{formatNumber(stats.tokenUsage)}</p>
            </div>
          </div>
        </div>
      </div>
