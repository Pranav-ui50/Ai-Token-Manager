        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {loadingPlan ? (
              ...
              <div className="bg-gradient-to-r from-[#DC2626]/10 to-[#DC2626]/5 border border-[#DC2626]/20 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-gray-900">
                      {selectedPlan.billing?.price === 0 ? 'Free' : `$${selectedPlan.billing?.price || 0}`}
                      {selectedPlan.billing?.price > 0 && <span className="text-sm font-normal text-gray-500">/mo</span>}
                    </p>
                ...
                <Link to="/pricing" className="text-sm text-[#DC2626] hover:underline mt-2 inline-block">
                  Change plan
                </Link>
              </div>
            ) : null}
